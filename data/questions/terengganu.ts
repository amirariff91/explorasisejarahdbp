...
export const terengganuQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      'Perdana Menteri ke-3',
      'Gagasan 1 Malaysia',
      'Menjadi Perdana Menteri pada 3 April 2009',
      'Perdana Menteri ke-6',
      'Dilahirkan di Kuala Lipis',
      'Anak Perdana Menteri ke-2',
      'Berasal dari Melaka',
      'Menteri Pertahanan',
      'Lahir 31 Ogos 1963',
    ],
    ...
    explanation: 'Dato\' Sri Mohd Najib adalah Perdana Menteri ke-6 Malaysia yang menjadi Perdana Menteri pada 3 April 2009. Beliau memperkenalkan Gagasan 1 Malaysia dan merupakan anak kepada Perdana Menteri ke-2, Tun Abdul Razak.',
  },
];
